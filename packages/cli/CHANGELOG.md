...
- 9a68eae: `sparkforensics-analyze` now exits 2 with the usage text on an unknown flag, a flag missing its
...
- 438e1b7: Add a `--export-html` flag to `sparkforensics-analyze` that writes a
