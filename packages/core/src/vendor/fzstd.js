// Vendored from fzstd@0.1.1 (esm/index.mjs), MIT license.
// https://github.com/101arrowz/fzstd — Copyright (c) 2020 Arjun Barrett.
// esm/index.mjs sha256 1a901fc5a58c349bbdb4f2aa1e688637ef56891ec58243a9f0cd863166b0d2a4
...
var Decompress = /*#__PURE__*/ (function () {
     ...
     */
    // Upstream self-recurses once per Zstandard frame boundary found within a
    // chunk (both `return this.push(...)` sites below, originally). Spark's
    // event-log writer flushes its output stream periodically while a job is
    // running, so one entry can be thousands of concatenated zstd frames —
    // enough recursion depth to blow the JS stack (surfaces as postMessage
    // failing, since emit() is called from deep inside this call chain).
    // Patched to a labeled loop so frame-boundary continuation is O(1) stack.
