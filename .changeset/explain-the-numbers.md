...
The scorecard now explains itself: Wall-clock, Efficiency and Idle capacity (renamed from Wastage)
each say in Basic view what they measure and whether higher or lower is better, so a high
Efficiency next to a high Idle capacity no longer reads as a contradiction. Advanced view keeps the
